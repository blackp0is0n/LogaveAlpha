...
- (BOOL)canDrawMapRect:(MKMapRect)mapRect zoomScale:(MKZoomScale)zoomScale {
    ...
    // overlay "data model".)
    NSString *path = [NSTemporaryDirectory() stringByAppendingPathComponent:[NSString stringWithFormat:@"%lu%lu%lu", (unsigned long)tilex, (unsigned long)tiley, (unsigned long)zoomLevel]];
